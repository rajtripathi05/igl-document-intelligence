# Certificate of Origin Processor

## Purpose

This folder is reserved for the future enterprise certificate_of_origin document processor.
...
validation scenarios, and export mapping notes for Certificate of Origin.
