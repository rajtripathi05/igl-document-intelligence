# Customer PO Processor

## Purpose

This folder is reserved for the future enterprise customer_po document processor.
...
validation scenarios, and export mapping notes for Customer PO.
