...
This folder is reserved for the future enterprise commercial_invoice document processor.
...
validation scenarios, and export mapping notes for Commercial Invoice.
